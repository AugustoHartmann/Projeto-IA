...
<div class="text-center" id="body" style="background-image: url('data:image/png;base64,<?php echo $livro[0][3] ?>');background-position: center;background-repeat: no-repeat;background-size: cover;">
